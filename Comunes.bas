...
Public gs4 As String  'Variable de uso múltiplo
Public gi As Long
...
Public gsWWW As String  'URL de la página WEB que desea verse
...
Public gdVersión As Date 'Fecha de la versión del Ejecutable
Public MDI As MDI_Prin


Sub Main()
Dim adors As New ADODB.Recordset
'gdVersión = "17/feb/2020"
'gdVersión = "09/dic/2020"
'gdVersión = "25/mar/2021"
'gdVersión = "03/may/2022"
'gdVersión = "09/dic/2022" 'Ajuste consulta de ins activas en SINE, Despliegue de SINE en CHROME
'gdVersión = "03/ago/2023" 'Ajuste Informes Consulta Tabular se agregó filtro por IF, Se agregó informe de NO Recibidos, programación de todos los reportes por UNA IF procesados al día siguiente
gdVersión = "03/ago/2023" 'SE AGREGÓ BOTONES DE ACTVIDAD ANTERIOR Y SIGUIENTE

gidesa = 0 '0:Producción, 1:Desarrollo

If gidesa = 0 Then 'Producción
    gsConexión = "DSN=SIAM;pwd=siam_desa;Provider=SQLOLEDB"
    
    'gsConexión = "DSN=SIAM2;DRIVER=Oracle in ORACLI;PWD=siam_desa"
    
    gsConexión = "FILEDSN=" & App.Path & "\siam.dsn;pwd=siam_desa;"
    
    'gsConexión = "FILEDSN=c:\siam.dsn;pwd=siam_desa;"
    
    'MsgBox (gsConexión)
    
Else 'Desarrollo
    gsConexión = "FILEDSN=" & App.Path & "\siamdesa.dsn;pwd=SIAMTEST;"
End If
...
gsVersión = "1.06" & " (" & Format(gdVersión, "dd/mm/yyyy") & ")"
If adors(0) <> gdVersión Then
    Call MsgBox("La versión del executable es diferente a la especificada en base de datos. Aunque puede trabajar con esta versión se sugiere contactar a los responsables del SIAM para su actualización", vbOKOnly + vbInformation, "")
End If
...
Case 2  'después de limpiar análogo a nuevo
    'txtCampo(0).Locked = False
    .Toolbar.Buttons(1).Enabled = True  '(yPer = 2 Or yPer = 5 Or yPer = 7 Or yPer = 8)
    .Toolbar.Buttons(2).Enabled = True
